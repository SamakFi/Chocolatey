...
$arguments = @{}
  ...
  $checksum32 = '22ae33babe447fb28789bce713a20cbee796a37c'
  $url64 = 'http://javadl.oracle.com/webapps/download/AutoDL?BundleId=218833_e9e7ea248e2c4826b92b3f075a80e441'
  $checksum64 = 'a963c6b8a012e658a3d657c4897cf7c8'
  $oldVersion = '8.0.1110.14'
  $version = '8.0.1210.13'
  #--------------------------------------------------------------------------
  $homepath = $version -replace "(\d+\.\d+)\.(\d\d)(.*)",'jre1.$1_$2'
  $installerType = 'exe'
  $installArgs = "/s REBOOT=0 SPONSORS=0 AUTO_UPDATE=0 REMOVEOUTOFDATEJRES=1 $32dir"
  $installArgs64 = "/s REBOOT=0 SPONSORS=0 AUTO_UPDATE=0 REMOVEOUTOFDATEJRES=1 $64dir"
